...
Files: macbook-16.glb [639.28KB] > /Users/shavonnewhiffin/Users/shavonnewhiffin/Desktop/Projects/apple-macbook-gsap/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(()=>{
    scene.traverse((child)=>{
      if(child.isMesh) {
        // Change color only if part name is in the no change parts (constants)
        if(child.isMesh){
