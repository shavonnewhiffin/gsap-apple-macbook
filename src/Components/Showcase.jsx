                ...
                <div className="lg:max-w-md">
                    ...
                    <p>Introducing {""}
                        <span className="text-white">
                           ...
                           M4 powers. It drives Apple Intelligence on iPad Pro, so you can write, create, and accomplish more with ease. All in a design that's unbelievably thin, light, and powerful.
                        </p> 
                        <p>
